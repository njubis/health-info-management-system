...
import { Link, type RequestEventLoader, routeLoader$, type DocumentHead } from "@builder.io/qwik-city";
import type { PlatformCloudflarePages } from "@builder.io/qwik-city/middleware/cloudflare-pages";

  export const useClientProfile = routeLoader$(async (event: RequestEventLoader<PlatformCloudflarePages>)=>{
...
export default component$(() => {
  ...
  return (
    <div class="flex justify-center items-center min-h-screen transition-all">
        <div class="max-w-[720px] mx-auto">
            <div class="block mb-4 mx-auto border-b border-slate-300 pb-2 max-w-[360px]">
                <span class="text-sm block w-full px-4 py-2 text-center text-red-700 transition-all">
            ...
            <div class="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
                ...
                <div class="flex flex-col gap-4 p-6">
                    <div class="relative h-11 w-full min-w-[200px]">
                        <input
                          onInput$={(_, inputEle)=>{
                            enableLoginSig.value = inputEle.value === '1234' ? true: false;
                          }}
